...
/**
 * Represents a product visitor that is used when for the product object.
 * It visits the various Values and outputs an array of double representing
 * if the value should be ignored or not, and the actual value (if it is a number).
 */
