...
/**
 * To represent a product function. It multiples 2 cells or a range of cells. (eg. 1 * 2 -> 2).
 */
class Product extends AbstractFunction {
  ...
  /**
   * If there are blank or non-number cells, they are ignored. If all inputs are non-number, then
   * outputs 0. Otherwise, outputs the product of the cells.
   *
